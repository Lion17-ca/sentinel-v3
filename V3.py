...
class ModernSentinelApp(QMainWindow):
    ...
    def _create_sidebar(self) -> QFrame:
        """
        Barre latérale avec boutons : Pause/Reprendre, Actualiser, Exporter, Effacer
    ...
    def _open_settings(self):
        ...
        if dialog.exec_() == QDialog.Accepted:
            ...
            # 2) (optionnel) si l'utilisateur a décoché le chiffrement
            # => vous pouvez désactiver l'EncryptionManager, etc.
            # 3) etc.
